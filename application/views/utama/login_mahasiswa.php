		...
		<div class="container">
			<div class="row">
				...
				<div class="left d-md-block   col-md-4  offset-md-1  col-sm-12 mt-5 ">
					<h4 class="mt-5 mb-5 text-center text-uppercase">Login Mahasiswa</h4>
					<?php echo $this->session->flashdata('message'); ?>
					<?= $this->session->unset_userdata('message'); ?>
					<form method="POST" action="<?php echo base_url('mahasiswa/login/Auth') ?>" class="my-login-validation" novalidate="">
