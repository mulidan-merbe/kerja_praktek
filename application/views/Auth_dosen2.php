		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title">LOGIN DOSEN 2</h4>
							<?php echo $this->session->flashdata('message'); ?>
							<form method="POST" action="<?php echo base_url('Auth_dosen2/Auth') ?>"class=" my-login-validation" novalidate="">
								<div class="form-group">
									<label for="NIP">NIP</label>
									<input id="NIP" type="text" class="form-control" name="username" value="<?= set_value('username') ?>" autofocus>
