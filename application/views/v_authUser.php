				...
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							...
							<form method="POST" action="<?= base_url('Auth') ?>"class=" my-login-validation" >
								<div class="form-group">
									<label for="no_identitas">No Identitas</label>
									<input id="No_identitas" type="text" class="form-control" name="No_identitas" value="<?= set_value('No_identitas') ?>" >
