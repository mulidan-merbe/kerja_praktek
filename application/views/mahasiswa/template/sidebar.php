    ...
    <ul class="nav flex-column">
      <li class="nav-item">
        <a class="nav-link <?php if ($this->uri->segment(2) == "beranda") {
                              echo "active";
                            } ?>" href="<?= base_url('mahasiswa/beranda') ?>">
          <i class="material-icons">home</i>
          <span>Beranda</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php if ($this->uri->segment(2) == "tawaran_topik" || $this->uri->segment(2) == "rencana_topik") {
                              echo "active";
                            } ?>" href="<?= base_url('mahasiswa/tawaran_topik') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if ($this->uri->segment(2) == "pembimbingLapangan") {
                              echo "active";
                            } ?>" href="<?= base_url('mahasiswa/pembimbingLapangan') ?>">
          <i class="material-icons">description</i>
          <span>Pembimbing Lapangan</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php if ($this->uri->segment(2) == "konsultasi") {
                              echo "active";
                            } ?>" href="<?= base_url('mahasiswa/konsultasi') ?>">
          <i class="material-icons">description</i>
          <span>Konsultasi</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php if ($this->uri->segment(2) == "seminar") {
                              echo "active";
      ...
      <li class="nav-item">
        <a class="nav-link <?php if ($this->uri->segment(2) == "penilaian" || $this->uri->segment(2) == "beritaAcara") {
                              echo "active";
                            } ?>" href="<?= base_url('mahasiswa/penilaian') ?>">
          <i class="material-icons">description</i>
          <span>Penilaian</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php if ($this->uri->segment(2) == "laporan") {
                              echo "active";
                            } ?>" href="<?= base_url('mahasiswa/laporan') ?>">
          <i class="material-icons">description</i>
          <span>Laporan</span>
        </a>
      </li>
      <!--               <li class="nav-item">
                <a class="nav-link <?php if ($this->uri->segment(2) == "beritaAcara") {
                                      echo "active";
                                    } ?>" href="<?= base_url('mahasiswa/beritaAcara') ?>">
                  <i class="material-icons">description</i>
               ...
               -->
      <li class="nav-item">
        <a class="nav-link <?php if ($this->uri->segment(2) == "profil") {
                              echo "active";
