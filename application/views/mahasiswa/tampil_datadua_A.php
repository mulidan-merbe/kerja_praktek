            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card card-small mb-4">
                  ...
                  <div class="card-body">
                    <?php if ($proposal ) { ?>     
                      <a href="<?= base_url('mahasiswa/KP_TI_A02A/tambah') ?>" class="btn btn-primary" ><i class="fas fa-plus">&nbsp</i>Konsultasi Dosen</a> 
                    <?php } else { ?>
                       <button type="button" class="btn btn-primary" disabled><i class="fas fa-plus">&nbsp</i>Konsultasi Dosen</button>
                    <?php } ?>
                         ...
                         <!--  <td style="text-align: center"><?= $data->Berkas ?></td> -->
                          ...
                          <td style="text-align: center">
                            <div class="btn-group btn-group-sm" role="group" aria-label="Table row actions">
                              ...
                              <a class=" btn btn-info "  href="<?= base_url() ?>mahasiswa/KP_TI_A02A/ubah?Id=<?= $data->Id_duaA ?>">
