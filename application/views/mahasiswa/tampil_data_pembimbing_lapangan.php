                  ...
                  <h6>Pembimbing Lapangan
                    ...
                    <?php if ($pembimbing) { ?>
                      <?php if ($Id_proposal == $Id_proposal2) { ?>
                        <button type="button" class="btn btn-primary float-right" disabled><i class="fas fa-plus">&nbsp</i></button>
                      <?php } else { ?>
                        <a class="btn btn-primary float-right" href="<?= base_url('mahasiswa/pembimbingLapangan/tambah') ?>"><i class="fas fa-plus">&nbsp</i> </a>
                      <?php } ?>
                    <?php } else { ?>
                      <?php if ($dua) { ?>
                        <a class="btn btn-primary float-right" href="<?= base_url('mahasiswa/pembimbingLapangan/tambah') ?>"><i class="fas fa-plus">&nbsp</i> </a>
                    ...
                    <?php if ($cekdata <= 1) { ?>
                      ...
                      foreach ($pembimbing as $data) { ?>
                        <form action="" class="">
                          ...
                          <div class="form-group row" class="mt-1">
                          ...
                          <div class="form-group row" class="mt-1">
                            <label for="" class="col-sm-2">No Handphone: </label>
                            <div class="col-sm-10">
                          ...
                          <div class="">
                            ...
                            <a class="mb-2 btn btn-sm btn-info " href="<?= base_url() ?>mahasiswa/pembimbingLapangan/ubah/<?= $data->NIM ?>"> <i class="material-icons">&#xE254;</i></a>
                          </div>
                        </form>
                      <?php } ?>
                    <?php } else { ?>
