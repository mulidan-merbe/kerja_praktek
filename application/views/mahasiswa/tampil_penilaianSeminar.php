        ...
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          ...
          <div class="flash-data" data-flashdata="<?= $this->session->flashdata('flash'); ?>"></div>
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
              <a type="button3" class="btn btn-info <?php if($this->uri->segment(2)=="penilaian"){echo "active";} ?>" href="<?= base_url('mahasiswa/penilaian') ?>">Penilaian Seminar 
              </a>
              <a type="button3" class="btn btn-info " href="<?= base_url('mahasiswa/beritaAcara') ?>">Berita Acara
              </a>
            </div>
            <div class="row">
              <div class="col">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">Pernilaian Lapangan</h6>
                  </div>
                   ...
                   <div class="card-body" style="min-height: 180px;">
                    ...
                    <?php 
                        ...
                        foreach ($empatB as $data) { 
                          $Total2 = $data->Nilai_satu + $data->Nilai_dua + $data->Nilai_tiga + $data->Nilai_empat + $data->Nilai_lima; 
                          $Jumlah = 5;
                          $Rata2   = $Total2 / $Jumlah;
                        ...
                        ?> 
                          ...
                          <tr>
                            ...
                            <td class="text-center"><span class="badge badge-success"><?= $Total ?></span></td>
                            <td class="text-center"><span class="badge badge-info"><?= $Rata1 ?></span></td>
                            <td class="text-center"><?= $format1 = format_indo(date('Y-m-d', strtotime( $data->Tanggal ))); ?> </td>
                            <td class="text-center">
                            <div class="btn-group btn-group-sm" role="group" aria-label="Table row actions">
                              <a href="<?= base_url()?>mahasiswa/penilaian/detailPenilaianDosen" class="mb-2 btn btn-success "><i class="fas fa-eye"></i></a>
                            </div>
                          </td>
                          </tr>
                          <tr>
                            <td><b>Pembimbing Lapangan</b></td>
                            <td class="text-center"><span class="badge badge-success"><?= $Total2 ?></span></td>
                            <td class="text-center"><span class="badge badge-info"><?= $Rata2 ?></span></td>
                            <td class="text-center"><?= $format1 = format_indo(date('Y-m-d', strtotime( $data->Tanggal ))); ?> </td> 
                            <td class="text-center">
                            <div class="btn-group btn-group-sm" role="group" aria-label="Table row actions">
                              <a href="<?= base_url()?>mahasiswa/penilaian/detailPenilaianLapangan" class="mb-2 btn btn-success "><i class="fas fa-eye"></i></a>
                            </div>
                          </td>
                          </tr>
