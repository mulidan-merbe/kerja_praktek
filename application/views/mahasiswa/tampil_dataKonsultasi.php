              ...
              <div class="modal-content">
                ...
                <form method="post" action="<?= base_url('dosen/rencana_judul/updateRencanajudul') ?>" enctype="multipart/form-data">
                  <div class="modal-body mx-3">
                    ...
                    <div class="form-group">
                      <label>Berkas :</label>
                      <a class="btn btn-sm btn-light" onclick=" window.open('<?= base_url('assets/KonsultasiDosen/file/') . $data->File ?>')"><img width="20" class="user-avatar rounded-circle mr-2" src="<?= base_url('assets/back') ?>/images/avatars/pdf.svg" alt="User Avatar">
                      </a>
                    </div>
                  </div>
              ...
              <div class="modal-content">
                ...
                <form method="post" action="<?= base_url('dosen/rencana_judul/updateRencanajudul') ?>" enctype="multipart/form-data">
                  <div class="modal-body mx-3">
                    ...
                    <div class="form-group">
                      <label>Berkas :</label>
                      <a class="btn btn-sm btn-light" onclick=" window.open('<?= base_url('assets/KonsultasiLapangan/file/') . $data->File ?>')"><img width="20" class="user-avatar rounded-circle mr-2" src="<?= base_url('assets/back') ?>/images/avatars/pdf.svg" alt="User Avatar">
                      </a>
                    </div>
                  </div>
                  <div class="modal-footer d-flex justify-content-center">
