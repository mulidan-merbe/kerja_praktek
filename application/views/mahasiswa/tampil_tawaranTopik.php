      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="btn-group" role="group" aria-label="Basic example">
            <a type="button3" class="btn btn-info <?php if ($this->uri->segment(2) == "tawaran_topik") {
                                                    echo "active";
                                                  } ?>" href="<?= base_url('mahasiswa/tawaran_topik') ?>">Tawaran Topik
            </a>
                    ...
                    <table id="dtBasicExample" class="table mb-0 table-bordered table-striped">
                      <thead class="">
                        <tr>
                          ...
                          <th class="text-center  col-3"><b>Topik</th>
