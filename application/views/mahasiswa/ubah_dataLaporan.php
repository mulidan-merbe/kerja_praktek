                      ...
                      <?php foreach ($ubah as $data) { ?>
                        <form method="post" action="<?= base_url('mahasiswa/laporan/ubahData') ?>" enctype="multipart/form-data">
                          <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="Id_laporan" value="<?= $data->Id_laporan ?>" multiple>
                            <input type="hidden" class="form-control" name="Berkas" value="<?= $data->Berkas ?>" multiple>
                          ...
                          <div class="form-group">
                            ...
                            <i><small><b>* Pastikan format berkas PDF untuk Seminar dan ZIP/RAR file akhir</b></small></i><br>
