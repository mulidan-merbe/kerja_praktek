            ...
            <div class="col">
              <div class="card card-small mb-4">
                ...
                <div class="card-body " style="min-height: 375px;">
                  <div class="">
                    <div class="card-body">
                      <form method="post" action="<?= base_url('mahasiswa/pembimbingLapangan/tambah') ?>" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group">
                              ...
                              <input type="file" class="form-control" id="file" name="Berkas" value="<?= set_value('Berkas') ?>" multiple>
