                      ...
                      foreach ($jadwal as $data) { ?>
                        <form action="">
                          <div class="form-group row">
                            <label for="" class="col-sm-3">Hari</label>:
                            <div class="col-sm-8">
                              <input type="text" class="form-control " value="<?= $data->Hari ?>" readonly>
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="" class="col-sm-3">Tanggal Seminar</label>:
                            <div class="col-sm-8">
                              <input type="text" class="form-control " value="<?= $format1 = format_indo(date('Y-m-d', strtotime($data->Tanggal_seminar))); ?>" readonly>
                            </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            <label for="" class="col-sm-3">Ruangan</label>:
                            <div class="col-sm-8">
                              <input type="text" class="form-control " value="<?= $data->Ruangan ?>" readonly>
                            </div>
                          </div>
                        </form>
                      <?php } ?>
      ...
      <div class="modal fade" id="modal-tambah" tabindex="-1" role="dialog" labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form method="post" action="<?= base_url('mahasiswa/seminar/tambahData') ?>" enctype="multipart/form-data">
