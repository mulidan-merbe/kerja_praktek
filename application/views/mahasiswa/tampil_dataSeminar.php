              ...
              <div class="col-md-7">
                ...
                <div class="table-responsive">
                  <div class="card-header border-bottom">
                   ...
                   <div class="card-body">
                      <table id="" class=" table  mb-0  table-striped">
                        <?php 
                        $no = 1;
                        foreach ($kpempat as $data) { ?>
                        <tr>
                          <th  class="col-3"><b>Hari  </b></th>
                           <td >: <?= $data->Hari ?></td>

                        </tr>
                        <tr>
                          <th ><b>Tanggal Seminar </b></th>
                          <td >: <?= $format1 = format_indo(date('Y-m-d', strtotime( $data->Tanggal_seminar ))); ?></td>
                        </tr>
                        <tr>
                          <th ><b>Waktu </b></th>
                          <td >: <?= $data->Waktu ?></td>
