            ...
            <div class="col">
              <div class="card card-small mb-4">
                <div class="card-header border-bottom">
                  <h6>Ubah Konsultasi Pembimbing Lapangan
                ...
                <div class="card-body " style="min-height: 375px;">
                  <div class="row">
                    <div class="col-12">
                      ...
                      <form method="post" action="<?= base_url('mahasiswa/konsultasi/ubahDataKonsultasiLapangan') ?>" enctype="multipart/form-data">
                        <?php foreach ($ubah as  $data) { ?>
                          <div class="form-group">
                            <input type="hidden" name="Id" class="form-control" value="<?= $data->Id_duaB ?>">
                          </div>
