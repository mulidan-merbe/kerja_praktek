                      ...
                      <form method="post" action="<?= base_url('mahasiswa/laporan/tambah') ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="Keterangan">
                            ...
                            <!-- <option value="<?= set_value('Keterangan') ?>"><b></b></option> -->
                            <?= form_error('Keterangan', '<small class="text-danger pl-3">', '</small>'); ?>
                          </select>
                        </div>
                        <div class="form-group">
                          <label for="email">Berkas :</label><br>
                          <i><small><b>* Pastikan format berkas PDF untuk Seminar dan ZIP/RAR file akhir</b></small></i>
                          <input type="file" class="form-control" name="Berkas" value="<?= set_value('Berkas') ?>" multiple>
