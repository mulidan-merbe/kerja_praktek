              ...
              <div class="col">
                <div class="card card-small mb-4">
                  ...
                  <div class="card-body " style="min-height: 375px;">   
                    ...
                    <form method="post" action="<?= base_url('admin/jadwal_pelaksanaan/tambah') ?>" enctype="multipart/form-data">
                    <div class="row"> 
                      <div class="col-md-6 col-sm-12"> 
                        ...
                        <label>Tanggal Mulai :</label>
                         <input type="date"  class="form-control" id="date" name="Tanggal_mulai" placeholder="dd-mm-yyyy" value="<?= set_value('Tanggal_mulai') ?>" multiple>
                        <?= form_error('Tanggal_mulai', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                        <label>Pengajuan Seminar :</label>
                         <input type="date"  class="form-control" id="date3" name="Pengajuan_seminar" placeholder="dd-mm-yyyy" value="<?= set_value('Pengajuan_seminar') ?>" multiple>
                        <?= form_error('Pengajuan_seminar', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                          <label>Revisi dan Pengumpulan Laporan :</label>
                          <input type="date"  class="form-control" id="date5" name="RevisiDpengumpulan" placeholder="dd-mm-yyyy" value="<?= set_value('RevisiDpengumpulan') ?>" multiple>
                      ...
                      <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="Periode" >
                            ...
                            <option value="<?= set_value('Periode') ?>"><b></b></option>
                          </select>
                          <?= form_error('Periode', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                          <label>Tanggal Berakhir :</label>
                          <input type="date"  class="form-control" id="date2" name="Tanggal_selesai" placeholder="dd-mm-yyyy" value="<?= set_value('Tanggal_selesai') ?>" multiple>
                          <?= form_error('Tanggal_selesai', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                          <label>Pelaksanaan seminar :</label>
                          <input type="date"  class="form-control" id="date4" name="Pelaksanaan_seminar" placeholder="dd-mm-yyyy" value="<?= set_value('Pelaksanaan_seminar') ?>" multiple>
