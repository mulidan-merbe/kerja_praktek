      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="btn-group mb-2" role="group" aria-label="Basic example">
            <a type="button2" class="btn btn-info <?php if ($this->uri->segment(2) == "seminar") {
                                                    echo "active";
                                                  } ?>" href="<?= base_url('admin/seminar') ?>">pernyataan siap seminar
                          ...
                          <tr>
                            ...
                            <td style="text-align: center">
                              <div class="btn-group btn-group-sm " role="group" aria-label="Table row actions">
                                ...
                                <a class="mb-2 btn btn-danger tombol-hapus" href="<?= base_url() ?>admin/seminar/hapusData?Id=<?= $data->Id ?>">
                                  <i class="material-icons">&#xE872;</i>
                                </a>
                              </div>
                            </td>
          ...
          <div class="modal fade" id="modal-tambah" tabindex="-1" role="dialog" labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form method="post" action="<?= base_url('admin/seminar/syaratPengajuan') ?>" enctype="multipart/form-data">
          ...
          <div class="modal fade" id="modal-ubah<?= $data->Id ?>" tabindex="-1" role="dialog" labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form method="post" action="<?= base_url('admin/seminar/ubahData') ?>" enctype="multipart/form-data">
                  <div class="modal-body mx-3">
                    <div class="form-group">
                      <label for="uraian">Tahun :</label>
                      <input type="text" class="form-control" name="Tahun" value="<?= $data->Tahun ?>" disabled>
