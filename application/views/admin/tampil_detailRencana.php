                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="btn-group btn-group-sm " role="group" aria-label="Table row actions">
                               ...
                               <a  class="mb-2 btn  btn-success" href="<?= base_url('')?>admin/rencana_topik/setuju?setujui=<?= $data->Id_rencanajudul ?>"  data-placement="top" title="Lihat" ><i class="fas fa-check"></i></a>
                              <a  class="mb-2 btn  btn-danger" href="<?= base_url('')?>admin/rencana_topik/tolak?ditolak=<?= $data->Id_rencanajudul ?>"  data-placement="top" title="Lihat" ><i class="fas fa-times"></i></a>
                            </div>
                          </td> 
                        </tr>
                        <?php } ?>
