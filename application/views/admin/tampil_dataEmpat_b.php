        ...
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          ...
          <div class="flash-data" data-flashdata="<?= $this->session->flashdata('flash'); ?>"></div>
            ...
            <div class="btn-group mb-2" role="group" aria-label="Basic example">
              ...
              <a type="button2" class="btn btn-info " href="<?= base_url('admin/penilaian/seminarDosen') ?>">penilaian seminar dosen</a>
              <a type="button3" class="btn btn-info <?php if($this->uri->segment(3)=="seminarLapangan"){echo "active";} ?>" href="<?= base_url('admin/penilaian/seminarLapangan') ?>">penilaian seminar lapangan</a>
            </div>
            <div class="row">
              <div class="col">
