      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="btn-group mb-2" role="group" aria-label="Basic example">
            <a type="button3" class="btn btn-info <?php if ($this->uri->segment(2) == "proposal") {
                                                    echo "active";
                                                  } ?>" href="<?= base_url('admin/proposal') ?>">Proposal</a>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        ...
                        <select name="filter" id="filter" class="form-control">
                          ...
                          <option value="1">Per Periode</option>
                          <option value="2">Per Tahun</option>
                          <option value="3">Per Dosen</option>
                      ...
                      <div class="col-md-3">
                        ...
                        <div id="form-dosen">
                          ...
                          <select name="NIP" class="form-control">
                            <option value="">Pilih</option>
                            <option value="987654321">Novi Safriadi, S.T, M.T</option>
        ...
        <script>
          $(document).ready(function() { // Ketika halaman selesai di load
            $('#form-tahun, #form-dosen, #form-periode ').hide(); // Sebagai default kita sembunyikan form filter tanggal, bulan & tahunnya
            $('#filter').change(function() { // Ketika user memilih filter
              if ($(this).val() == '1') { // Jika filter nya 1 (per tanggal)
                $('#form-dosen').hide(); // 
                $(' #form-tahun, #form-periode').show();
              } else if ($(this).val() == '2') { // 
                $(' #form-dosen, #form-periode').hide();
                $('#form-tahun').show(); // Tampilkan form bulan dan tahun
              } else if ($(this).val() == '3') { // 
                $(' #form-tahun, #form-periode').hide();
