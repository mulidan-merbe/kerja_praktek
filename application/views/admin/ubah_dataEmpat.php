      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="btn-group mb-2" role="group" aria-label="Basic example">
            ...
            <a type="button3" class="btn btn-info <?php if ($this->uri->segment(2) == "jadwal") {
                                                    echo "active";
                                                  } ?>" href="<?= base_url('admin/jadwal') ?>">jadwal seminar</a>
          </div>
          <div class="row">
            <div class="col">
                ...
                <div class="card-body " style="min-height: 420px;">
                  <div class="">
                    <div class="card-body">
                      ...
                      <form method="post" action="<?= base_url('admin/jadwal/ubahData') ?>" enctype="multipart/form-data">
                        <div class="row">
