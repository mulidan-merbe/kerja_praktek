      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="btn-group mb-2" role="group" aria-label="Basic example">
            ...
            <a type="button3" class="btn btn-info <?php if ($this->uri->segment(3) == "rencana") {
                                                    echo "active";
                                                  } ?>" href="<?= base_url('admin/topik/rencana') ?>">Rencana</a>
          </div>
          <div class="row">
            <div class="col">
                          ...
                          <td><?= $data->Username ?></td > -->
                            ...
                            <td class="text-center">
                              <div class="btn-group btn-group-sm" role="group" aria-label="Table row actions">
                                <a class="mb-2 btn  btn-info" href="<?= base_url('') ?>admin/rencana_topik/detail/<?= $data->Id_tawaranjudul ?>" data-placement="top" title="Lihat"><i class="fas fa-eye"></i></a>
                              </div>
                            </td>
                          </tr>
                        <?php } ?>
