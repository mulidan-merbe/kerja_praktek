              ...
              <div class="col">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">Ubah Akun Pembimbing Lapangan
                        ...
                        <div class="card-body">
                          <div class="row"> 
                            ...
                            <?php foreach ($ubah as $data) {
                              ...
                              <form method="post" action="<?= base_url('admin/UserPembimbing/tambahData') ?>" enctype="multipart/form-data">
                              <div class="form-group">
                                <label for="email">Nama  :</label>
                                <input type="text" name="Nama" id="form1" class="form-control"  value="<?= $data->Nama ?>">
