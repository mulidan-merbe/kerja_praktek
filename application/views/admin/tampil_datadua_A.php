      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="btn-group mb-2" role="group" aria-label="Basic example">
            <a type="button2" class="btn btn-info <?php if ($this->uri->segment(2) == "konsultasi") {
                                                    echo "active";
                                                  } ?>" href="<?= base_url('admin/konsultasi') ?>">Konsultasi Dosen</a>
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <div class="btn-group btn-group-sm " role="group" aria-label="Table row actions">
                                <a class="mb-2 btn  btn-success" href="<?= base_url('') ?>admin/konsultasi/detail/<?= $data->NIM ?>" data-placement="top" title="Lihat"><i class="fas fa-eye"></i></a>
                              </div>
                            </td>
                          </tr>
                        <?php } ?>
