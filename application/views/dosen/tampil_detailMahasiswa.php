                ...
                <div class="table-responsive">
                   <div class="card-body">
                    ...
                    <?php 
                     ...
                     <div class="row">
                     	<div class="col-md-12 col-sm-12">
                     		<form method="post" action="<?= base_url('dosen/KP_TI_A04C/tambahData') ?>" enctype="multipart/form-data">
                    ...
                    <?php 
                        ...
                        $totalsemua = ($total + $total2 + $total3)
                         ?>
                              ...
                              <tr>
                                <td style="text-align: center;">Penilaian Lapangan</td>
                                <td style="text-align: center;">Pembimbing Lapangan</td>
                              ...
                              <tr>
                              <tr>
                                <td style="text-align: center;">Penilaian Seminar Kerja Praktek</td>
                                <td style="text-align: center;">Pembimbing Lapangan</td>
