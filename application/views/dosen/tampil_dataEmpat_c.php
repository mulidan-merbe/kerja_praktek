      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <a type="button3" class="btn btn-info <?php if ($this->uri->segment(2) == "beritaAcara") {
                                                    echo "active";
                                                  } ?>" href="<?= base_url('dosen/beritaAcara') ?>">Berita Acara
            </a>
          </div>
          <div class="row">
            <div class="col">
                      ...
                      <tbody>
                        ...
                        foreach ($nilai as $data) { ?>
                          <tr>
                            ...
                            <td class="text-center"><?= $data->Icon ?></td>
                            <td class="text-center"><?= $format1 = format_indo(date('Y-m-d', strtotime($data->Tanggal_dosen))); ?></td>
                            <td class="text-center">
                              <div class="btn-group btn-group-sm " role="group" aria-label="Table row actions">

                                <a class="mb-2 btn  btn-info " href="<?= base_url() ?>dosen/beritaAcara/ubah/<?= $data->NIM ?>"><i class="material-icons">&#xE254;</i></a>
                              </div>
