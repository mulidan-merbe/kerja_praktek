                      ...
                      <tbody>
                        ...
                        foreach ($proposal as $data) { ?>
                          <tr>
                            ...
                            <td><?= $data->nama ?></td>
                            <td><?= $data->topik ?></td>
                            <td class="text-center "><a class="mb-2 btn btn-sm btn-light mr-1" href="<?= base_url('assets/proposal/') . $data->Berkas ?>"><img width="20" class="user-avatar rounded-circle mr-2" src="<?= base_url('assets/back') ?>/images/avatars/pdf.svg" alt="User Avatar"></a></td>
