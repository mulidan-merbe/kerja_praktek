            ...
            <div class="row">
              <div class="col">
                ...
                <div class="table-responsive">
                   <div class="card-body" style="min-height: 395px">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $data->nama ?></td>
                              ...
                              <a class="btn-sm btn-light" href="<?= base_url('assets/laporan/file/').$data->Berkas ?>"><img width="30" class="user-avatar rounded-circle mr-2" src="<?= base_url('assets/back')?>/images/avatars/zipp.svg" alt="User Avatar">
                              </a>
                            </td>
