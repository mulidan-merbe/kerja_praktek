                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <a class="mb-2 btn btn-sm  btn-light mr-1" href="<?= base_url('assets/Konsultasipembimbing/file/').$data->Berkas ?>"><img width="20" class="user-avatar rounded-circle mr-2" src="<?= base_url('assets/back')?>/images/avatars/pdf.svg" alt="User Avatar">
                            </a>
                          </td>
                          <td class="text-center"><?= $data->Icon ?></td> 
                          <td class="text-center">
                            <div class="btn-group btn-group-sm " role="group" aria-label="Table row actions">
                              <a   class="mb-2 btn  btn-info" data-toggle="modal" data-target="#modal-lihat<?=$data->Id_duaB; ?>" data-placement="top" title="Lihat" ><i class="fas fa-eye"></i></a>
                               <a  class="mb-2 btn  btn-success" href="<?= base_url('')?>pembimbing/konsultasi/setuju?setujui=<?= $data->Id_duaB ?>&NIM=<?= $data->NIM ?>"  data-placement="top" title="Lihat" ><i class="fas fa-check"></i></a>
                              <a  class="mb-2 btn  btn-danger" href="<?= base_url('')?>pembimbing/konsultasi/tolak?ditolak=<?= $data->Id_duaB ?>&NIM=<?= $data->NIM ?>"  data-placement="top" title="Lihat" ><i class="fas fa-times"></i></a>
                            </div>
                          </td> 
                        </tr>
                        <?php } ?>
