...
class Profil extends CI_Controller
{
	...
	{
		parent::__construct();
		$this->load->model('Model_Pembimbing_lapangan');
	...
	public function index()
	{
		...
		$data['profil']	= $this->Model_Pembimbing_lapangan->getPembimbing($No_identitas);
	...
	public function ubahPassword()
	{
		$data['title']  	= 'Pembimbing | Profil';
		$No_identitas 	= $this->session->userdata('No_identitas');
		$data['user']	= $this->Model_Pembimbing_lapangan->getPembimbingubah($No_identitas);
